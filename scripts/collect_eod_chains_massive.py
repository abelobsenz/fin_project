...
from spygen.pipeline import collect_eod_chains_asof_massive, load_config


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Collect EOD-style SPY option chains from Massive into data/raw"
    )
    ...
    print(f"Saved option chain parquet (Massive): {out}")
